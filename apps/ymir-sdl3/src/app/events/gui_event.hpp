...
constexpr std::string_view GUIEventToString(GUIEvent::Type type) {
    switch (type) {
        case GUIEvent::Type::LoadDisc:
            return "LoadDisc";
        case GUIEvent::Type::LoadRecommendedGameCartridge:
            return "LoadRecommendedGameCartridge";
        case GUIEvent::Type::OpenBackupMemoryCartFileDialog:
            return "OpenBackupMemoryCartFileDialog";
        case GUIEvent::Type::OpenROMCartFileDialog:
            return "OpenROMCartFileDialog";
        case GUIEvent::Type::OpenPeripheralBindsEditor:
            return "OpenPeripheralBindsEditor";
        case GUIEvent::Type::OpenFile:
            return "OpenFile";
        case GUIEvent::Type::OpenManyFiles:
            return "OpenManyFiles";
        case GUIEvent::Type::SaveFile:
            return "SaveFile";
        case GUIEvent::Type::SelectFolder:
            return "SelectFolder";
        case GUIEvent::Type::OpenBackupMemoryManager:
            return "OpenBackupMemoryManager";
        case GUIEvent::Type::OpenSettings:
            return "OpenSettings";
        case GUIEvent::Type::OpenSH2DebuggerWindow:
            return "OpenSH2DebuggerWindow";
        case GUIEvent::Type::OpenSH2BreakpointsWindow:
            return "OpenSH2BreakpointsWindow";
        case GUIEvent::Type::OpenSH2WatchpointsWindow:
            return "OpenSH2WatchpointsWindow";
        case GUIEvent::Type::SetProcessPriority:
            return "SetProcessPriority";
        case GUIEvent::Type::SwitchGraphicsBackend:
            return "SwitchGraphicsBackend";
        case GUIEvent::Type::FitWindowToScreen:
            return "FitWindowToScreen";
        case GUIEvent::Type::ApplyFullscreenMode:
            return "ApplyFullscreenMode";
        case GUIEvent::Type::RebindInputs:
            return "RebindInputs";
        case GUIEvent::Type::ReloadGameControllerDatabase:
            return "ReloadGameControllerDatabase";
        case GUIEvent::Type::ShowErrorMessage:
            return "ShowErrorMessage";
        case GUIEvent::Type::EnableRewindBuffer:
            return "EnableRewindBuffer";
        case GUIEvent::Type::TryLoadIPLROM:
            return "TryLoadIPLROM";
        case GUIEvent::Type::ReloadIPLROM:
            return "ReloadIPLROM";
        case GUIEvent::Type::IPLROMLoaded:
            return "IPLROMLoaded";
        case GUIEvent::Type::TryLoadCDBlockROM:
            return "TryLoadCDBlockROM";
        case GUIEvent::Type::ReloadCDBlockROM:
            return "ReloadCDBlockROM";
        case GUIEvent::Type::CheckForUpdates:
            return "CheckForUpdates";
        case GUIEvent::Type::TakeScreenshot:
            return "TakeScreenshot";
        case GUIEvent::Type::StateLoaded:
            return "StateLoaded";
        case GUIEvent::Type::StateSaved:
            return "StateSaved";
        default:
            return "Unknown";
    }
